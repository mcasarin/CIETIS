...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">6º CIETIS</a>
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
        <span>Usuário: <?php echo $_SESSION['nome']; ?></span>
...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="inscr_total.php" target="inside">
        ...
        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted text-uppercase">
          <span>Apresentação de Trabalhos</span>
    ...
    <iframe name="inside" id="inside" src="graph.php" width="800" height="550">
        </iframe>
